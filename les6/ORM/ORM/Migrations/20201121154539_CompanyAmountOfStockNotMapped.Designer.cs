...
namespace ORM.Migrations
{
    ...
    [Migration("20201121154539_CompanyAmountOfStockNotMapped")]
    partial class CompanyAmountOfStockNotMapped
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ORM.Model.Review", b =>
                {
                    ...
                    b.Property<int?>("ProductOrganisationId")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("ProductSequenceNumber")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ProductOrganisationId", "ProductSequenceNumber");
            ...
            modelBuilder.Entity("ORM.Model.Review", b =>
                {
                    ...
                    b.HasOne("ORM.Model.Product", "Product")
                        .WithMany("Reviews")
                        .HasForeignKey("ProductOrganisationId", "ProductSequenceNumber");
