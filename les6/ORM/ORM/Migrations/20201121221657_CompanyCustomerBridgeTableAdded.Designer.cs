...
namespace ORM.Migrations
{
    ...
    [Migration("20201121221657_CompanyCustomerBridgeTableAdded")]
    partial class CompanyCustomerBridgeTableAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ORM.Model.CompanyCustomer", b =>
                {
                    ...
                    b.HasKey("OrganisationId", "CustomerId");
            ...
            modelBuilder.Entity("ORM.Model.CompanyCustomer", b =>
                {
                    b.HasOne("ORM.Model.Customer", "Customer")
            ...
            modelBuilder.Entity("ORM.Model.Review", b =>
                {
                    b.HasOne("ORM.Model.Product", "Product")
                        .WithMany("Reviews")
                        .HasForeignKey("OrganisationId", "SequenceNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
